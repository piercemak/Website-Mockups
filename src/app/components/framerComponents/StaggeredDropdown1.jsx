...
const Option = ({ text, Icon, setOpen }) => {
  return (
    <motion.li
      ...
      className='flex items-center gap-2 w-full p-2 text-xs font-medium whitespace-nowrap rounded-md hover:bg-blue-100 hover:text-blue-600 transition-colors cursor-pointer'
    >
...
export const MenuToggle = ({ toggle }) => (
  <div onClick={toggle}>
    <svg className='size-4 text-blue-500' viewBox="0 0 23 23">
      <Path
        variants={{
        ...
        <div className='sm:hidden flex items-center justify-center'>
            <motion.div animate={open ? "open" : "closed"}>
                <button 
                    ...
                    className='flex items-center gap-2 px-3 py-2 rounded-md text-blue-500'
                >
                ...
                <motion.ul
                    ...
                    className= "absolute flex flex-col gap-2 p-2 rounded-lg bg-gray-200 shadow-lg transition-all" 
                >
                    <Option setOpen={setOpen} Icon={productIcon} text="Products" />
                    <Option setOpen={setOpen} Icon={claimIcon} text="Claim Center" />
                    <Option setOpen={setOpen} Icon={billIcon} text="Pay Your Bill" />
                    <Option setOpen={setOpen} Icon={libraryIcon} text="Policy Form Library" />
                    <Option setOpen={setOpen} Icon={partnerIcon} text="Partner With Us" />
                    <Option setOpen={setOpen} Icon={findIcon} text="Find an Agent" />
                </motion.ul>
            </motion.div>
        </div>
    )
